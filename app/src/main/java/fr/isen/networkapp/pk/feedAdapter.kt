...
import fr.isen.networkapp.databinding.PostCellBinding

class feedAdapter(private val entries: List<String>): RecyclerView.Adapter<CategoryAdapter.DishesViewHolder>() {
